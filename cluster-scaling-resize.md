...
3. [Resize](/docs/openshift?topic=openshift-kubernetes-service-cli#worker-pool-resize-cli) or [rebalance](/docs/openshift?topic=openshift-kubernetes-service-cli#worker-pool-rebalance-cli) your worker pool.
