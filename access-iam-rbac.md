...
- Ensure that you have the [**Manager** IAM service access role for all namespaces](/docs/openshift?topic=openshift-iam-platform-access-roles) or the **Administrator** platform role.
