...
| DevOps operator | [Operator platform access role for a cluster](/docs/openshift?topic=openshift-iam-platform-access-role), [Writer service access role not scoped to a namespace (for the whole cluster)](/docs/openshift?topic=openshift-iam-service-access-roles), [Cloud Foundry developer space role](/docs/openshift?topic=openshift-cloud-foundry-roles).  |
...
You can [manually assign users to groups](https://docs.openshift.com/container-platform/4.11/authentication/understanding-authentication.html){: external} in your cluster, and then assign roles to the group.
