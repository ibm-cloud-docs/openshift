...
*   **{{site.data.keyword.keymanagementserviceshort}}**, if you [enable a key management service provider](/docs/openshift?topic=openshift-encryption#kms) in your cluster.
