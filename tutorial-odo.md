...
* **Learn more about OpenShift Do**: Learn more about the features of `odo` by visiting the [{{site.data.keyword.redhat_openshift_notm}} Do CLI Documentation](https://odo.dev/docs/introduction/){: external}.
