...
### Worker node fix pack 4.17.40_1558_openshift, released 08 October 2025
{: #cl-boms-41740_1558_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.40_1558_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.40|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-40_release-notes).|
...
### Worker node fix pack 4.17.39_1554_openshift, released 23 September 2025
{: #cl-boms-41739_1554_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.39_1554_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.39|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-39_release-notes).|
|HAProxy|e0a48fcf355d98dc769ea048d2fd02044b11ed62|N/A|
{: caption="4.17.39_1554_openshift fix pack." caption-side="bottom"}
{: #cl-boms-41739_1554_openshift_W-component-table}


### Worker node fix pack 4.17.38_1552_openshift, released 09 September 2025
{: #cl-boms-41738_1552_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.38_1552_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.38|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-38_release-notes).|
...
{: caption="4.17.38_1552_openshift fix pack." caption-side="bottom"}
{: #cl-boms-41738_1552_openshift_W-component-table}


### Worker node fix pack 4.17.37_1551_openshift, released 26 August 2025
{: #cl-boms-41737_1551_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.37_1551_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="4.17.37_1551_openshift fix pack." caption-side="bottom"}
{: #cl-boms-41737_1551_openshift_W-component-table}


### Master fix pack 4.17.36_1550_openshift, released 20 August 2025
{: #41736_1550_openshift_M}

The following table shows the changes that are in the master fix pack 4.17.36_1550_openshift. Master patch updates are applied automatically. 


| Component | Previous | Current | Description |
| --- | --- | --- | --- |
| etcd | v3.5.21 | v3.5.22 | See the [etcd release notes](https://github.com/etcd-io/etcd/releases/v3.5.22){: external}. |
| {{site.data.keyword.cloud_notm}} Controller Manager | v1.30.14-4 | v1.30.14-6 | New version contains updates and security fixes. |
...
| {{site.data.keyword.openshiftlong_notm}} | 4.17.35 | 4.17.36 | See the [{{site.data.keyword.openshiftlong_notm}} release notes](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes#ocp-4-17-36_release-notes){: external}. |
| {{site.data.keyword.openshiftlong_notm}} Control Plane Operator, Metrics Server, and toolkit | v4.17.0+20250627 | v4.17.0+20250808 | See the [{{site.data.keyword.openshiftlong_notm}} toolkit release notes](https://github.com/openshift/ibm-roks-toolkit/releases/tag/v4.17.0+20250808){: external}. |
{: caption="Changes since version 4.17.35_1547_openshift" caption-side="bottom"}
...
### Worker node fix pack 4.17.36_1548_openshift, released 28 July 2025
{: #cl-boms-41736_1548_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.36_1548_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.36|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-36_release-notes).|
...
{: caption="4.17.36_1548_openshift fix pack." caption-side="bottom"}
{: #cl-boms-41736_1548_openshift_W-component-table}


### Worker node fix pack 4.17.35_1546_openshift, released 14 July 2025
{: #cl-boms-41735_1546_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.35_1546_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.35|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-35_release-notes).|
...
{: caption="4.17.35_1546_openshift fix pack." caption-side="bottom"}
{: #cl-boms-41735_1546_openshift_W-component-table}


### Worker node fix pack 4.17.34_1545_openshift, released 01 July 2025
{: #cl-boms-41734_1545_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.34_1545_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.34|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-34_release-notes).|
|HAProxy|951efd90b46e95a54751966c644ac37c4c901f92|N/A|
{: caption="4.17.34_1545_openshift fix pack." caption-side="bottom"}
{: #cl-boms-41734_1545_openshift_W-component-table}
...
| {{site.data.keyword.openshiftlong_notm}} Control Plane Operator, Metrics Server, and toolkit | 4.17.0+20250509 | 4.17.0+20250610 | See the [{{site.data.keyword.openshiftlong_notm}} toolkit release notes](https://github.com/openshift/ibm-roks-toolkit/releases/tag/v4.17.0+20250610){: external}. |
...
### Worker node fix pack 4.17.33_1544_openshift, released 16 June 2025
{: #cl-boms-41733_1544_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.33_1544_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.33|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-33_release-notes).|
...
{: caption="4.17.33_1544_openshift fix pack." caption-side="bottom"}
{: #cl-boms-41733_1544_openshift_W-component-table}


### Worker node fix pack 4.17.31_1541_openshift, released 04 June 2025
{: #cl-boms-41731_1541_openshift_W}

The following table shows the components included in the worker node fix pack 4.17.31_1541_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.31|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes.html#ocp-4-17-31_release-notes).|
...
| {{site.data.keyword.openshiftlong_notm}}. | 4.17.24 | 4.17.28 | See the [{{site.data.keyword.openshiftlong_notm}} release notes](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes#ocp-4-17-28){: external}. |
| {{site.data.keyword.openshiftlong_notm}} Control Plane Operator, Metrics Server, and toolkit | 4.17.0+20250414 | 4.17.0+20250509 | See the [{{site.data.keyword.openshiftlong_notm}} toolkit release notes](https://github.com/openshift/ibm-roks-toolkit/releases/tag/v4.17.0+20250509){: external}. |
...
The following table shows the components included in the worker node fix pack 4.17.23_1535_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift and Red Hat CoreOS|4.17.17|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes#ocp-4-17-17_release-notes).|
...
| {{site.data.keyword.openshiftshort}} | 4.17.5 | 4.17.8 | For more information, see the [change logs](https://docs.redhat.com/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes#ocp-4-17-8_release-notes){: external}.|
...
| {{site.data.keyword.openshiftlong_notm}}. | 4.17.4 | 4.17.5 | See the [{{site.data.keyword.openshiftlong_notm}} release notes](https://docs.redhat.com/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes#ocp-4-17-5){: external}. |
...
| Red Hat OpenShift (master) | 4.16.19 | 4.17.4 | See the [Red Hat OpenShift on IBM Cloud release notes](https://docs.redhat.com/documentation/openshift_container_platform/4.17/html/release_notes/ocp-4-17-release-notes#ocp-4-17-4_release-notes) |
