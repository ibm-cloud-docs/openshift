...
Access from the OpenShift master to the worker node's kubelet is secured by an OpenVPN tunnel. For more information, see the [Red Hat OpenShift on IBM Cloud architecture](/docs/containers?topic=containers-service-arch).
