...
<dl>
  ...
  <dd>Store personal information only in Kubernetes resources that are designed to hold personal information. For example, do not use your name in the name of an {{site.data.keyword.openshiftshort}} project, deployment, service, or config map. For proper protection and encryption, store personal information in [secrets](https://docs.openshift.com/container-platform/3.11/dev_guide/secrets.html){: external} instead.</dd>
