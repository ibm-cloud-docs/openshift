...
* Reconfigure apps into a set of cooperative microservices. That set runs within {{site.data.keyword.openshiftlong_notm}} that is based on functional areas of the app with the most quality problems.
