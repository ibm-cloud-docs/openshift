...
If you use Portworx in a classic cluster, see [Updating Classic worker nodes](/docs/openshift?topic=openshift-update&interface=ui#worker_node). The following steps focus on VPC worker node updates.
