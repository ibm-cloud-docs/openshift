...
Before you begin:
- Make sure that you have the correct [permissions](/docs/containers?topic=containers-clusters&interface=ui) to create {{site.data.keyword.openshiftlong_notm}} clusters.
