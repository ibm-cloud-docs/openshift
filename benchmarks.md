...
| 1.2.13 | Ensure that the admission control plugin SecurityContextDeny is set if PodSecurityPolicy is not used | Not Scored | 1 | [Pass](#ibm-remediations-and-explanations) | {{site.data.keyword.IBM_notm}} |
...
| 1.2.16 | Ensure that the admission control plugin PodSecurityPolicy is set | Scored | 1 | [Pass](#ibm-remediations-and-explanations) | {{site.data.keyword.IBM_notm}} |
...
| 1.2.21 | Ensure that the `--profiling` option is set to false | Scored | 1 | - Version 4.9 and later: Pass \n - Versions 4.8 and earlier: [Fail](#ibm-remediations-and-explanations) | {{site.data.keyword.IBM_notm}} |
