...
keywords: openshift, openshift data foundation, openshift container storage, vpc
...
| 5 | Secret ref | A secret ref is a reference to a Kubernetes secret in your cluster. When you create an Object Bucket Claim, NooBaa creates a corresponding secret and config map. Then, you can reference the secret and config map in your apps without needing to directly include the credentials in your apps. |
