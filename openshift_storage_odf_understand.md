...
:   ODF uses these devices to create a virtualized storage layer, where your app data is replicated for high availability. Because ODF abstracts your underlying storage, you can create use ODF to creat File, Block, or Object storage claims all from the same underlying raw block storage.
