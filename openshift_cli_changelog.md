...
Version 0.3 of the CLI plug-in is deprecated. Ensure that your {{site.data.keyword.openshiftlong_notm}} plug-in uses the latest `0.4` version by running `ibmcloud plugin update kubernetes-service`.
{: deprecated}
...
Version 0.2 of the CLI plug-in is deprecated. Ensure that your {{site.data.keyword.openshiftlong_notm}} plug-in uses the latest `0.4` version by running `ibmcloud plugin update kubernetes-service`.
{: deprecated}
...
Version 0.1 of the CLI plug-in is deprecated. Ensure that your {{site.data.keyword.openshiftlong_notm}} plug-in uses the latest `0.4` version by running `ibmcloud plugin update kubernetes-service`.
{: deprecated}
