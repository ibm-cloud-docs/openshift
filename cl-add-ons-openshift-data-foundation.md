...
### 4.12.13, released 29 November 2023 
...
### 4.10.10, released 01 September 2022
...
### 4.9.4, released 13 April 2022
{: #cl-add-ons-openshift-data-foundation-4.9.4}

UBI update.

### 4.9.3, released 23 March 2022
{: #cl-add-ons-openshift-data-foundation-4.9.3}

- Updates Golang.
- Updates the UBI.

### 4.9.2, released 24 February 2022
{: #cl-add-ons-openshift-data-foundation-4.9.2}

Use PVC for mon on VPC.

### 4.9.1, released 23 February 2022
{: #cl-add-ons-openshift-data-foundation-4.9.1}

Updates the UBI.

### 4.9.0, released 11 February 2022
{: #cl-add-ons-openshift-data-foundation-4.9.0}
...
### 4.8.4, released 17 January 2022
{: #cl-add-ons-openshift-data-foundation-4.8.4}

Updates Golang version to 1.16.13.

### 4.8.3, released Jan 07, 2022
{: #cl-add-ons-openshift-data-foundation-4.8.3}

- Updates UBI image.
- Adds increased logging.


### 4.8.2, released 03 January 2022
{: #cl-add-ons-openshift-data-foundation-4.8.2}

- Removes MON parameters.
- Introduces local disk discovery.


### 4.8.1, released 17 November 2021
{: #cl-add-ons-openshift-data-foundation-4.8.1}

- Removes {{site.data.keyword.satelliteshort}} link parameter.
- Updates Golang to 1.16.10.
- Updates the UBI.

### 4.8.0, released 25 October 2021
{: #cl-add-ons-openshift-data-foundation-4.8.0}
...
### 4.7.13, released 13 October 2021
{: #cl-add-ons-openshift-data-foundation-4.7.13}

Adds an agent health check.


### 4.7.12, released 30 September 2021
{: #cl-add-ons-openshift-data-foundation-4.7.12}

Includes an NC check fix.

### 4.7.11, released 29 September 2021
{: #cl-add-ons-openshift-data-foundation-4.7.11}

- Adds NC check.
- Updates the UBI.

### 4.7.10, released 15 September 2021
{: #cl-add-ons-openshift-data-foundation-4.7.10}

Adds a fix for multiple operator groups. 


### 4.7.9, released 06 September 2021
{: #cl-add-ons-openshift-data-foundation-4.7.9}

- Adds agent check
- Adds enhancements to cleanup.

### 4.7.8, released 16 August 202
{: #cl-add-ons-openshift-data-foundation-4.7.8}

- Updates the UBI.
- Updates Golang to 1.16.7.

### 4.7.7, released 27 July 2021
{: #cl-add-ons-openshift-data-foundation-4.7.7}

- Updates the UBI.
- Updates Golang to 1.16.6.

### 4.7.6, released 05 July 2021
