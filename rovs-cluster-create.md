...
3. Configure the cluster details:
   ...
   **OpenShift version**
   :   The latest supported version (4.20 or later) is automatically selected.
...
- [Explore VM templates and images](https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/virtualization/virtual-machines#virt-creating-vms-from-rh-images-overview){: external}
