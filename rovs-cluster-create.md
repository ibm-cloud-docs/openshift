...
5. Configure **Virtualization integrations**:
   ...
   **OpenShift Data Foundation (ODF)**
   ...
   - **Resource profile**: Performance (default, recommended for virtualization workloads)
...
- [Explore VM templates and images](https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/virtualization/index){: external}
- [Configure virtual machine networking](https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/virtualization/index){: external}
