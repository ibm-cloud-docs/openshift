...
| Container-native virtualization | You can install a [container-native virtualization add-on](https://docs.openshift.com/container-platform/4.5/cnv/cnv-about-cnv.html){: external} to run VM workloads alongside container workloads. | You can set up container-native virtualization on bare metal machines, but not on virtual machines.|
