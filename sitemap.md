...
* [Step 2: Importing the peer pod image](/docs/openshift?topic=openshift-confidential-containers#peer-pod-image)

* [Step 3: Creating an API key or trusted profile](/docs/openshift?topic=openshift-confidential-containers#api-key-or-trusted-profile)

* [Step 4: Creating an SSH key (Optional)](/docs/openshift?topic=openshift-confidential-containers#ssh-key)

* [Step 5: Configuring confidential containers](/docs/openshift?topic=openshift-confidential-containers#configure-confidential-containers)

* [Step 6: Configuring a trust authority](/docs/openshift?topic=openshift-confidential-containers#trustee)

* [Step 7: Running a confidential container workload](/docs/openshift?topic=openshift-confidential-containers#run-workload)
...
* [How to find the VPE gateways for a VPC cluster](/docs/openshift?topic=openshift-ts-network-nhc004#find-vpe-gateways)
    ...
    * [1. Use the IBM Cloud CLI to list endpoint gateways](/docs/openshift?topic=openshift-ts-network-nhc004#list-gateways-from-cli)

    * [2. Use the IBM Cloud console to list endpoint gateways](/docs/openshift?topic=openshift-ts-network-nhc004#list-gateways-in-cloud-console)

    * [3. After finding the VPE gateway hostname complete the following steps.](/docs/openshift?topic=openshift-ts-network-nhc004#error-checking)
