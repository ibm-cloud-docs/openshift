...
* [Adding {{site.data.keyword.appid_short_notm}} authentication to apps](/docs/openshift?topic=openshift-ingress-settings#app-id)
  * [Adding {{site.data.keyword.appid_short_notm}} for ALBs that run the Red Hat OpenShift on IBM Cloud Ingress image](/docs/openshift?topic=openshift-ingress-settings#app-id-iks)
  * [Adding {{site.data.keyword.appid_short_notm}} for ALBs that run the community Kubernetes Ingress image](/docs/openshift?topic=openshift-ingress-settings#app-id-kube)
