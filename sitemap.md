...
* [Kubernetes resource permissions per RBAC role](/docs/openshift?topic=openshift-iam-service-access-roles#rbac_ref)
    ...
    * [`bindings`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-bindings)

    * [`configmaps`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-configmaps)

    * [`cronjobs.batch`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-cronjobs)

    * [`daemonsets.apps`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-ds-apps)

    * [`daemonsets.extensions`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-ds-extensions)

    * [`deployments.apps`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-dep-apps)

    * [`deployments.apps/rollback`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-dep-rollback)

    * [`deployments.apps/scale`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-dep-apps-scale)

    * [`deployments.extensions`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-dep-extensions)

    * [`deployments.extensions/rollback`](/docs/openshift?topic=openshift-iam-service-access-roles#deploymentsextensionsrollback)

    * [`deployments.extensions/scale`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-dep-extensions-scale)

    * [`endpoints`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-endpoints)

    * [`events`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-events)

    * [`horizontalpodautoscalers.autoscaling`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-hpas)

    * [`ingresses.extensions`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-configmaps)

    * [`jobs.batch`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-jobs-batch)

    * [`limitranges`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-limitranges)

    * [`localsubjectaccessreviews`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-localsubjectaccessreviews)

    * [`namespaces`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-namespaces)

    * [`namespaces/status`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-namespaces-status)

    * [`networkpolicies`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-networkpolicies)

    * [`networkpolicies.extensions`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-networkpolicies-extensions)

    * [`node`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-node)

    * [`persistentvolume`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-persistentvolume)

    * [`persistentvolumeclaims`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-persistentvolumeclaims)

    * [`poddisruptionbudgets.policy`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-poddisruptionbudgets-policy)

    * [`pods`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-pods)

    * [`pods/attach`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-pods-attach)

    * [`pods/exec`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-pods-exec)

    * [`pods/log`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-pods-log)

    * [`pods/portforward`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-pods-portforward)

    * [`pods/proxy`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-pods-proxy)

    * [`pods/status`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-pods-status)

    * [`replicasets.apps`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicasets-apps)

    * [`replicasets.apps/scale`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicasets-apps-scale)

    * [`replicasets.extensions`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicasets-extensions)

    * [`replicasets.extensions/scale`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicasets-extensions-scale)

    * [`replicationcontrollers`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicationcontrollers)

    * [`replicationcontrollers/scale`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicationcontrollers-scale)

    * [`replicationcontrollers/status`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicationcontrollers-status)

    * [`replicationcontrollers.extensions/scale`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-replicationcontrollers-extensions-scale)

    * [`resourcequotas`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-resourcequotas)

    * [`resourcequotas/status`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-resourcequotas-status)

    * [`rolebindings`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-rolebindings)

    * [`roles`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-roles)

    * [`secrets`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-secrets)

    * [`serviceaccounts`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-serviceaccounts)

    * [`services`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-services)

    * [`services/proxy`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-services-proxy)

    * [`statefulsets.apps`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-statefulsets-apps)

    * [`statefulsets.apps/scale`](/docs/openshift?topic=openshift-iam-service-access-roles#rbac-statefulsets-apps-scale)
