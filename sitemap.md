...
* [`ibmcloud oc init`](/docs/openshift?topic=openshift-kubernetes-service-cli#init-cli)
    ...
    * [Command options](/docs/openshift?topic=openshift-kubernetes-service-cli#init-options)

    * [Examples](/docs/openshift?topic=openshift-kubernetes-service-cli#init-examples)
