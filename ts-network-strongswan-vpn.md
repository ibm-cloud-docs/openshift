...
The strongSwan IPSec VPN add-on is deprecated, and will be unsupported on December 20, 2025.  See [Classic VPN connectivity](/docs/openshift?topic=openshift-vpn#vpn) for other options
{: note}
