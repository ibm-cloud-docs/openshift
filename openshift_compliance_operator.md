...
- [Understanding the compliance operator](https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/security_and_compliance/compliance-operator#understanding-compliance-operator){: external} documentation set.
