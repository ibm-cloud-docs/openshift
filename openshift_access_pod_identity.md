...
1.  [Design your pod configuration file](/docs/openshift?topic=openshift-openshift_apps) to use [service account token volume projection](https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/#service-account-token-volume-projection){: external}. 
...
4.  [Deploy your app](/docs/openshift?topic=openshift-deploy_app).
