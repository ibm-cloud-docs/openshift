...
To allow private network traffic requests from outside the cluster to your apps, you can use private Kubernetes networking services, such as creating [`LoadBalancer` services](/docs/openshift?topic=openshift-vpclb-about). For example, when you create a Kubernetes `LoadBalancer` service in your cluster, a load balancer for VPC is automatically created in your VPC outside of your cluster. The VPC load balancer is multizonal and routes requests for your app through the private NodePorts that are automatically opened on your worker nodes. For VPC ALBs and NLBs, a [security group](/docs/openshift?topic=openshift-vpc-security-group-reference), named in the form of `kube-lbaas-<cluster-id>`, is automatically attached to your load balancers.
...
You can use public Kubernetes networking services, such as creating [`LoadBalancer` services](/docs/openshift?topic=openshift-vpclb-about). For example, when you create a Kubernetes `LoadBalancer` service in your cluster, a load balancer for VPC is automatically created in your VPC outside of your cluster. The VPC load balancer is multizonal and routes requests for your app through the private NodePorts that are automatically opened on your worker nodes. For VPC ALBs and NLBs, a [security group](/docs/openshift?topic=openshift-vpc-security-group-reference), named in the form of `kube-lbaas-<cluster-id>`, is automatically attached to your load balancers.
...
![Network setup for a VPC cluster that runs internet-facing app workloads.](images/roks_ov_vpc_pub.svg){: caption="Network setup for a VPC cluster that runs internet-facing app workloads" caption-side="bottom"}
...
![Network setup for a VPC cluster that extends an on-prem data center.](images/roks_ov_vpc_priv.svg){: caption="Network setup for a VPC cluster that extends an on-prem data center" caption-side="bottom"}
