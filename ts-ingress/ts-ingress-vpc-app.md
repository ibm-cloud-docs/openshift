...
{: tsCauses}
When you create a VPC cluster, one public and one private VPC load balancer are automatically created outside of your cluster in your VPC. The VPC load balancer routes requests to the apps that the routers expose. Requests cannot be routed to your app in the following situations:
