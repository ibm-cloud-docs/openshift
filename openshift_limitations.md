...
| Private clusters | You cannot create OpenShift clusters with a private service endpoint. Also, as with version 3.11, you cannot create clusters with only private VLAN connectivity. |
