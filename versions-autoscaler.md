...
The cluster autoscaler add-on doesn't support {{site.data.keyword.openshiftlong_notm}} version 1.25. Don't update your cluster to version 1.25 if you have this add-on installed.
{: important}
