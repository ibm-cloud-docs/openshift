...
- [File storage](/docs/openshift?topic=openshift-file_storage#add_file)
- [Block storage](/docs/openshift?topic=openshift-block_storage#add_block)
...
- [File storage](/docs/openshift?topic=openshift-file_storage#file_predefined_storageclass)
- [Block storage](/docs/openshift?topic=openshift-block_storage#block_predefined_storageclass)
...
- [File storage](/docs/openshift?topic=openshift-file_storage#file_storageclass_reference)
- [Block storage](/docs/openshift?topic=openshift-block_storage#block_storageclass_reference)
...
1. Create a customized storage class. You can start by using one of the pre-defined storage classes, or check out our sample customized storage classes.
   ...
   - Sample customized storage classes:
     - [File storage](/docs/openshift?topic=openshift-file_storage#file_custom_storageclass)
     - [Block storage](/docs/openshift?topic=openshift-block_storage#block_custom_storageclass)
...
- Use [existing NFS file storage](/docs/openshift?topic=openshift-file_storage#existing_file)
- Use [existing block storage](/docs/openshift?topic=openshift-block_storage#existing_block)
