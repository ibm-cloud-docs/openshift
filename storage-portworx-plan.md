...
1. **Optional** [Set up encryption](/docs/openshift?topic=openshift-storage_portworx_encyrption).
...
**Before you begin:** [Set up encryption](/docs/openshift?topic=openshift-storage_portworx_encyrption)
