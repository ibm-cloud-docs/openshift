...
- A {{site.data.keyword.openshiftlong_notm}} cluster. If you have a VPC cluster, make sure that your VPC has a public gateway attached. For more information, see [Creating clusters](/docs/openshift?topic=openshift-clusters)
