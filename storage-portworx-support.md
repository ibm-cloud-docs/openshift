...
4. Review the log files locally. If you can't resolve the issue by reviewing the logs, [open a support ticket](/docs/openshift?topic=openshift-get-help) and provide the log information that you collected.
