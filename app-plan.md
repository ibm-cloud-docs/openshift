...
You can also [connect multiple clusters in different regions with a global load balancer](/docs/openshift?topic=openshift-loadbalancer-qs) to increase the high availability.
