...
:   Direct VPC connectivity, floating IPs, and network preservation during live migration. Generally available with OpenShift 4.20. See [Managing VNIs](/docs/openshift?topic=openshift-vni-virtualization).
...
- VNI features require OpenShift 4.20 or later and allowlisted account access
