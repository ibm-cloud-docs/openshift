...
For more information, see [Monitoring](https://docs.openshift.com/container-platform/4.17/observability/monitoring/monitoring-overview.html){: external}.
