...
For more information, see [Monitoring](https://docs.openshift.com/container-platform/4.19/virt/monitoring/virt-monitoring-overview.html){: external}.
