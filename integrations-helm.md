...
- **ibm-community**: Helm charts that originated outside IBM, such as from {{site.data.keyword.openshiftlong_notm}} partners. These charts are supported and maintained by the community partners.
