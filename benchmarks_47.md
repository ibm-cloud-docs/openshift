...
| Section | Recommendation | Scored/Not Scored | Level | Result | Responsibility |
| --- | --- | --- | --- | --- | --- |
| 1.2.1 | Ensure that the `--anonymous-auth` option is set to `false`. | Not Scored | 1 | [Fail](#cis-benchmark-remediations-47) | {{site.data.keyword.IBM_notm}} |
...
| 1.2.21 | Ensure that the `--profiling` option is set to `false`. | Scored | 1 | [Fail](#cis-benchmark-remediations-47) | {{site.data.keyword.IBM_notm}} |
| 1.2.22 | Ensure that the `--audit-log-path` option is set. | Scored | 1 | [Fail](#cis-benchmark-remediations-47) | Shared |
| 1.2.23 | Ensure that the `--audit-log-maxage` option is set to `30` or as appropriate. | Scored | 1 | [Fail](#cis-benchmark-remediations-47) | Shared |
| 1.2.24 | Ensure that the `--audit-log-maxbackup` option is set to `10` or as appropriate. | Scored | 1 | [Fail](#cis-benchmark-remediations-47) | Shared |
| 1.2.25 | Ensure that the `--audit-log-maxsize` option is set to `100` or as appropriate. | Scored | 1 | [Fail](#cis-benchmark-remediations-47) | Shared |
...
| 1.2.33 | Ensure that the `--encryption-provider-config` option is set as appropriate. | Scored | 1 | [Fail](#cis-benchmark-remediations-47) | Shared |
...
| 4.2.6 | Ensure that the `--protect-kernel-defaults` option is set to `true`. | Scored | 1 | [Fail](#cis-benchmark-remediations-47) | {{site.data.keyword.IBM_notm}} |
| 4.2.7 | Ensure that the `--make-iptables-util-chains` option is set to `true`. | Scored | 1 | Pass | {{site.data.keyword.IBM_notm}} |
| 4.2.8 | Ensure that the `--hostname-override` option is not set. | Not Scored | 1 | [Fail](#cis-benchmark-remediations-47) | {{site.data.keyword.IBM_notm}} |
