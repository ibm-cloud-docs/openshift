...
| {{site.data.keyword.cloud_notm}} Block Storage driver and plug-in | v2.1.6 | v2.1.7 | Adds fix for CVE-2021-3538](https://www.mend.io/vulnerability-database/CVE-2021-3538){: external}. |
