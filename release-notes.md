...
:   Uninstall the Diagnostics and Debug Tool from your clusters before support ends. For more information, see [Running the Diagnostics and Debug Tool](/docs/openshift?topic=openshift-debug-tool).
