...
1. Review the `syslog` and `s3fslog` files for information about the `Transport endpoint` error. [Open a support ticket](/docs/openshift?topic=openshift-get-help) and share the log files that you gathered.
