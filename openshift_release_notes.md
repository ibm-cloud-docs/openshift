...
| Date | Description |
| ---- | ----------- |
| 24 September 2020 | **CLI changelog**: Updated the {{site.data.keyword.openshiftlong_notm}} CLI plug-in changelog page for the [release of version 1.0.1XX](/docs/openshift?topic=openshift-cs_cli_changelog#10). |
