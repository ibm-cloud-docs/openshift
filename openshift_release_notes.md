...
| Date | Description |
| ---- | ----------- |
| 10 February 2020 | <ul><li>**VPC cluster creation troubleshooting**: Added [troubleshooting steps](/docs/openshift?topic=openshift-cs_troubleshoot#ts_no_vpc) for when no VPCs are listed when you try to create a VPC cluster in the console.</li><li></li></ul> |
