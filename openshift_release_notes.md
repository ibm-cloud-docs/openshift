...
| 22 March 2021 | **Ingress ALB changelog**: Updated the [`nginx-ingress` build to 2466 and the `ingress-auth` build to 982](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog) for the {{site.data.keyword.openshiftlong_notm}} Ingress image. |
...
| 16 March 2021 | **Ingress ALB changelog**: Updated the [`nginx-ingress` build to 2458](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog) for the {{site.data.keyword.openshiftlong_notm}} Ingress image. |
...
| 19 November 2020 | **Ingress ALB changelog**: Updated the [`nginx-ingress` build to 653 and the `ingress-auth` build to 425](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog) for the {{site.data.keyword.openshiftlong_notm}} Ingress image. |
...
| 05 August 2020 | **Ingress ALB changelog**: Updated the [`nginx-ingress` image build to 647 and the `ingress-auth` image build to 421](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog). |
...
| 18 June 2020 | **Ingress ALB changelog**: Updated the [`ingress-auth` image build to 413](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).|
...
| 18 May 2020 | **Ingress ALB changelog**: Updated the [`nginx-ingress` image build to 628](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).|
...
| 16 April 2020 | **Ingress ALB changelog**: Updated the [`ingress-auth` image build to 394](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).|
...
| Date | Description |
| ---- | ----------- |
| 30 January 2020 | **Ingress ALB changelog**: Updated the [`nginx-ingress` image build to 625](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog). |
...
| Date | Description |
| ---- | ----------- |
| 18 December 2019 | **Ingress ALB changelog**: Updated the [`nginx-ingress` image build to 615 and the `ingress-auth` image to build 372](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog). |
...
<td><ul>
<li><strong>Ingress ALB changelog</strong>: Updated the [ALB `nginx-ingress` image to 597 and the `ingress-auth` image to build 353](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<li><strong>Ingress ALB changelog</strong>: Updated the [ALB `ingress-auth` image to build 345](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li></ul></td>
</tr>
<tr>
...
<td>23 October 2019</td>
  <td><ul>
    <li><strong>Ingress ALB changelog</strong>: Updated the ALB [`nginx-ingress` image to build 584 and `ingress-auth` image build to 344](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<tr>
  ...
  <td><ul>
  <li><strong>Ingress ALB changelog</strong>: Updated the ALB [`nginx-ingress` image to build 579 and `ingress-auth` image build to 341](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the ALB [`nginx-ingress` image to build 566](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
  </ul></td>
</tr>
<tr>
...
<tr>
  ...
  <td><strong>Ingress ALB changelog</strong>: Updated the ALB [`nginx-ingress` image to build 552](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</td>
</tr>
<tr>
...
<tr>
  ...
  <td><strong>Ingress ALB changelog</strong>: Updated the ALB [`ingress-auth` image to build 340](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</td>
</tr>
<tr>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the ALB [`nginx-ingress` image to build 524 and `ingress-auth` image to build 337](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<tr>
  ...
  <td><strong>Ingress ALB changelog</strong>: Updated the ALB [`nginx-ingress` image to build 519](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog) for a `custom-ports` bug fix.</td>
</tr>
<tr>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the ALB `ingress-auth` image to build 335 for [`musl libc` vulnerabilities](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li></ul></td>
</tr>
<tr>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the ALB `nginx-ingress` image to build 515 for the [ALB pod readiness check](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<tr>
  <td>17 July 2019</td>
  <td><strong>Ingress ALB changelog</strong>: [Fixes `rbash` vulnerabilities](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).
  </td>
</tr>
<tr>
  <td>15 July 2019</td>
  <td><ul>
  <li><strong>Ingress ALB changelog</strong>: Updated the [ALB `nginx-ingress` image to build 497](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the [ALB `nginx-ingress` image to build 477](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
  </ul></td>
</tr>
<tr>
  <td>21 June 2019</td>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the [ALB `nginx-ingress` image to build 473 and `ingress-auth` image to build 331](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the [ALB `ingress-auth` image to build 330](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
...
<tr>
  ...
  <li><strong>Ingress ALB changelog</strong>: Updated the [ALB `nginx-ingress` image to build 470](/docs/openshift?topic=openshift-cluster-add-ons-changelog#alb_changelog).</li>
  </ul></td>
</tr>
<tr>
  <td>05 June 2019</td>
