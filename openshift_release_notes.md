...
| Date | Description |
| ---- | ----------- |
| 17 February 2021 | <ul>**New! {{site.data.keyword.openshiftshort}} 4.6**: You can create or [update](/docs/openshift?topic=openshift-openshift_versions#ocp46) your cluster to {{site.data.keyword.openshiftshort}} version 4.6, which includes Kubernetes 1.19. With {{site.data.keyword.openshiftshort}} 4.6, you get the latest stable enhancements from the community, as well as beta access to features such as [API server priority](/docs/openshift?topic=openshift-kubeapi-priority). For more information, see the [blog announcement](https://www.ibm.com/cloud/blog/announcements/openshift-version-46-now-available-in-red-hat-openshift-on-ibm-cloud){: external}.</ul> |
