...
| Date | Description |
| ---- | ----------- |
| 03 December 2020 | <ul>**Cluster autoscaler**: Patch update `1.0.1_146` is available. For more information, see the [Cluster autoscaler add-on changelog](/docs/openshift?topic=openshift-ca_changelog). |
