...
| Date | Description |
| ---- | ----------- |
| 23 April 2020 | <ul><li>**OpenShift 4.3**: [OpenShift version 4.3](/docs/openshift?topic=openshift-openshift_versions#ocp43) is now the default version.</li>**Version changelogs**: Master patch updates are available for OpenShift [3.11.200_1548_openshift](/docs/openshift?topic=openshift-openshift_changelog#311200_1548).</li></ul> |
