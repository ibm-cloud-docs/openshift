...
The following table shows the components that are in the master fix pack 4.18.43_1593_openshift. Master patch updates are applied automatically.
{: shortdesc}
...
|Red Hat OpenShift on IBM Cloud 4.18.43|See the [Red Hat OpenShift on IBM Cloud release notes](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes#ocp-4-18-43_release-notes).|
{: caption="4.18.43_1593_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.43_1594_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift 4.18.43|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-42_release-notes).|
|Red Hat CoreOS 4.18.43|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-42_release-notes).|
...
{: caption="4.18.43_1594_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.42_1591_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift 4.18.42|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-42_release-notes).|
|Red Hat CoreOS 4.18.42|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-42_release-notes).|
...
{: caption="4.18.42_1591_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.41_1590_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|RHEL 9 (Satellite) 5.14.0-570.62.1.el9_6|N/A|
|Red Hat OpenShift 4.18.41|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-41_release-notes).|
|Red Hat CoreOS 4.18.41|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-41_release-notes).|
...
{: caption="4.18.41_1590_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.38_1587_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift 4.18.38|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-38_release-notes).|
|Red Hat CoreOS 4.18.38|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-38_release-notes). Includes mitigation for [CVE-2026-31431](https://nvd.nist.gov/vuln/detail/CVE-2026-31431).|
...
{: caption="4.18.38_1587_openshift fix pack." caption-side="bottom"}
...
The following table shows the components that are in the master fix pack 4.18.37_1586_openshift. Master patch updates are applied automatically.
{: shortdesc}
...
|IBM Cloud Controller Manager v1.31.14-19|New version contains updates and security fixes.|
...
|Red Hat OpenShift on IBM Cloud 4.18.37|See the [Red Hat OpenShift on IBM Cloud release notes](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes#ocp-4-18-37_release-notes).|
|Tigera Operator v1.38.13|See the [Tigera Operator release notes](https://github.com/tigera/operator/releases/tag/v1.38.13).|
{: caption="4.18.37_1586_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.37_1585_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift 4.18.37|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-37_release-notes).|
|Red Hat CoreOS 4.18.37|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-37_release-notes).|
...
{: caption="4.18.37_1585_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.36_1584_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift 4.18.36|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-36_release-notes).|
|Red Hat CoreOS 4.18.36|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-36_release-notes).|
...
{: caption="4.18.36_1584_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.34_1581_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
The following table shows the components included in the worker node fix pack 4.18.33_1580_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift 4.18.33|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-33_release-notes).|
|Red Hat CoreOS 4.18.33|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-33_release-notes). CIS benchmark compliance [5.2.2](https://workbench.cisecurity.org/sections/1594521/recommendations/2564440), [5.2.3](https://workbench.cisecurity.org/sections/1594521/recommendations/2564444), [5.2.4](https://workbench.cisecurity.org/sections/1594521/recommendations/2564446), [5.2.18](https://workbench.cisecurity.org/sections/1594521/recommendations/2564555)|
...
{: caption="4.18.33_1580_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.32_1578_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|Red Hat OpenShift 4.18.32|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-32_release-notes).|
|Red Hat CoreOS 4.18.32|For more information, see the [change logs](https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/release_notes/ocp-4-18-release-notes.html#ocp-4-18-32_release-notes). CIS benchmark compliance [5.3.7](https://workbench.cisecurity.org/sections/1594544/recommendations/2564601), [5.5.1](https://workbench.cisecurity.org/sections/1594548/recommendations/2564609), [5.5.2](https://workbench.cisecurity.org/sections/1594548/recommendations/2564612), [5.5.3](https://workbench.cisecurity.org/sections/1594548/recommendations/2564618), [5.6.1.1](https://workbench.cisecurity.org/sections/1594552/recommendations/2564624), [5.6.1.4](https://workbench.cisecurity.org/sections/1594552/recommendations/2564632) ,[5.6.5](https://workbench.cisecurity.org/sections/1594551/recommendations/2564644)|
...
{: caption="4.18.32_1578_openshift fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 4.18.30_1574_openshift. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="4.18.30_1574_openshift fix pack." caption-side="bottom"}
