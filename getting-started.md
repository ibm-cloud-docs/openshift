...
First, create a <roks311-vpc>classic</roks311-vpc> Red Hat OpenShift on IBM Cloud cluster<roks311-vpc> or a cluster on the first generation of compute infrastructure in a Virtual Private Cloud (VPC)</roks311-vpc>. Then, deploy and expose a sample app in your cluster. 
<br>
...
{: note}
  ...
  <div class="solutionBox">
   <a href = "#clusters_gs">
    <div>
         <h2><img src="images/icon-classic.png" alt="Classic infrastructure provider icon" width="15" style="width:15px; border-style: none"/> Create a <roks311-vpc>classic</roks311-vpc> cluster</h2>
         <p class="bx--type-caption">Create an OpenShift cluster on {{site.data.keyword.cloud_notm}} <roks311-vpc>classic</roks311-vpc> workers nodes, subnets, and VLAN networking. Choose from a variety of virtual, bare metal, GPU, or software-defined storage flavors.</p>
    </div>
    </a>
</div><roks311-vpc>
  <div class="solutionBox">
...
<roks311-vpc>**VPC clusters**: To set up the internal OpenShift Container Registry with a backing storage device for your images, see [Setting up the internal registry to use {{site.data.keyword.cloud_notm}} Object Storage](/docs/openshift?topic=openshift-images#vpc_setup_cos).</roks311-vpc>
