...
3.  Review the platform version details, **{{site.data.keyword.openshiftshort}} 4.6.22**.
...
3. Configure your cluster's VPC environment.
  1.  Review the platform version details, **{{site.data.keyword.openshiftshort}} 4.6.22**.
