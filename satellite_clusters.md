...
| OCP licensing fee | Per vCPU hour. You can either purchase a license during cluster creation or [bring your own](/docs/satellite?topic=satellite-faqs#byo-ocp-satellite). | Per vCPU hour. You can either purchase a license during cluster creation or [bring your own](/docs/satellite?topic=satellite-faqs#byo-ocp-satellite). |
