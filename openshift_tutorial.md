...
For more information about working with your apps, see the [{{site.data.keyword.redhat_openshift_notm}} developer activities](https://docs.redhat.com/documentation/openshift_container_platform/4.19/html/about/welcome-index#developer-activities){: external} documentation.
