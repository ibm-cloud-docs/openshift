...
4. **User access**:
    ...
    4. [Choose the scope of user access to cluster instances, {{site.data.keyword.redhat_openshift_notm}} project, or resource groups](/docs/containers?topic=containers-access-overview#resource_groups).
