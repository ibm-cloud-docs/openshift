...
| Replace a worker node. | [`ibmcloud oc worker-replace`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cs_worker_replace) | <ul><li>Classic: [`POST /v2​/replaceWorker`](https://containers.cloud.ibm.com/swagger-api/#/beta/replaceWorker)</li><li>VPC: [`POST /v2​/vpc​/replaceWorker`](https://containers.cloud.ibm.com/swagger-api/#/beta/vpcReplaceWorker)</li></ul> |
