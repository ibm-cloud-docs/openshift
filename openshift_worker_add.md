...
2. Resize the worker pool by designating the number of worker nodes that you want to deploy in each zone. Keep in mind that you must have a minimum of 1 worker node in your worker pool at all times, and at least 2 worker nodes per cluster.
    ```
