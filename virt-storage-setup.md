...
This section applies only to manual OpenShift Virtualization deployments. If you're using [OpenShift Virtualization Service](/docs/openshift?topic=openshift-rovs-getting-started), storage is pre-configured and you don't need to follow these steps.
{: note}
