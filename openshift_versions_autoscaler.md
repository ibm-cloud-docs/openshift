...
To view a list of add-ons and the supported {{site.data.keyword.openshiftlong_notm}} versions, run the following command.
```
...
| -------- | ------- | ----------- |
| N/A | 1.0.1 | <ul><li>The cluster autoscaler is available as a [managed add-on](/docs/openshift?topic=openshift-ca).</li><li>The add-on can be used with the following versions: {{site.data.keyword.openshiftshort}} minimum version 4.3.</li></ul> |
