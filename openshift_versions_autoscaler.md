...
| --- | --- | --- | --- | --- |
| `1.0.1 205` | <ul><li>`1.11.0-7`</li><li>`1.16.2-8`</li><li>`1.17.0-9`</li><li>`1.18.1-8`</li><li>`1.19.0 3`</li></ul> | 15 December 2020 | 4.3 - 4.6 | Updates the `initContainer` to use the universal base image (UBI). |
